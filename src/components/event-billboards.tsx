...
export function EventBillboards() {
  ...
  return (
    <section id="nights" className="bg-shade py-20 text-bleach sm:py-28" aria-label="Events billboard theater">
      ...
      >
        {events.map((event) => (
          ...
          >
            <Image src={event.image} alt="" fill className="object-cover" sizes="440px" draggable={false} />
