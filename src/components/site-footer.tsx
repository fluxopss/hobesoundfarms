    ...
    <footer className="border-t border-bleach/10 bg-ink text-bleach">
      <div className="mx-auto grid max-w-[1600px] gap-10 px-5 py-14 sm:px-10 md:grid-cols-[1.4fr_1fr_1fr] lg:pl-28">
        <div>
          <div className="flex items-center gap-3">
            <Image src={site.logo} alt={site.name} width={48} height={48} className="h-12 w-12 object-contain" />
        ...
        <div>
          ...
          <p className="mt-3 text-sm text-bleach/60">Market {site.marketHours}</p>
        </div>
        <div>
          <p className="font-stamp text-[9px] text-bleach/40">Explore</p>
          <ul className="mt-3 space-y-2 text-sm">
            <li>
              <Link href="/market" className="hover:text-flare">
                The Market
              </Link>
            </li>
            <li>
      ...
      <div className="border-t border-bleach/10 px-5 py-5 text-center text-xs text-bleach/40 sm:px-10">
        ...
        <a
          ...
          className="underline underline-offset-2 hover:text-bleach"
          target="_blank"
          rel="noreferrer"
        >
          Flux Labs
